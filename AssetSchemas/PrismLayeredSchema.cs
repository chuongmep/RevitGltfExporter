...
{
    class PrismLayeredSchema : IAssetSchema
    {
        public string colorByObjectKey => "prism_layered_color_by_object";
        ...
        public string reflectivityAt90degKey => "prism_layered_reflectivity_at_90deg";

        public string glossinessKey => "glossiness";

        public string isMetalKey => "prism_layered_is_metal";

        public string transparencyKey => "prism_layered_transparency";

        public string transparencyImageFadeKey => "prism_layered_transparency_image_fade";

        public string refractionIndexKey => "prism_layered_refraction_index";

        public string refractionTranslucencyWeightKey => "prism_layered_refraction_translucency_weight";

        public string cutoutOpacityKey => "cutout_opacity_map";

        public string backfaceCullKey => "prism_layered_backface_cull";

        public string selfIllumLuminanceKey => "prism_layered_self_illum_luminance";

        public string selfIllumColorTemperatureKey => "prism_layered_self_illum_color_temperature";

        public string bumpAmountKey => "bump_amount";

        public string bumpMapKey => "bump_map_asset";

        public string commonTintToggleKey => "prism_layered_common_Tint_toggle";
